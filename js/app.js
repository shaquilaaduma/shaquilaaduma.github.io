...
const util = (() => {
    ...
    const tamu = () => {
        ...
        div.innerHTML = `<p class="mt-0 mb-1 mx-0 p-0 text-light" style="font-size: 1rem; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; color: white; ">Kepada Yth Bapak/Ibu/Saudara/i</p><p class="text-light" style="font-size: 1.5rem; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; color: white; ">${escapeHtml(name)}</p>`;
